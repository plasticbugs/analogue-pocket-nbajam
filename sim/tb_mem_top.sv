...
module tb_mem_top (
    ...
    input  logic        init,
    output logic        ready,
    input  logic        rd_late, burst_slow, burst_fast, burst_fast_wr,
    ...
    nbajam_mem dut (
        ...
        .rd_late(rd_late), .burst_slow(burst_slow), .burst_fast(burst_fast), .burst_fast_wr(burst_fast_wr), .sram_slow(1'b0), .sram_slow_wr(1'b0),
